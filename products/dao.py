...
def list_products():
    ...
    # Fetch and sort products by a specific column (e.g., price or name)
    cursor.execute('SELECT * FROM products')  # Example sorting by 'price'
